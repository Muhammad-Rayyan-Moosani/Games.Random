 ...
 * MongoDB is optional - the app will work without it (game generation only)
 */
if (MONGODB_URI && MONGODB_URI !== 'mongodb://......') {
    mongoose.connect(MONGODB_URI)
        .then(() => {
            console.log('✅ Connected to MongoDB');
        })
        .catch((err) => {
            console.warn('⚠️  MongoDB connection failed - game saving disabled');
            console.warn('   Game generation will still work!');
            console.warn('   To enable saving: install MongoDB or use MongoDB Atlas');
        });
} else {
    console.warn('⚠️  MongoDB not configured - game saving disabled');
    console.warn('   Game generation will still work!');
}
